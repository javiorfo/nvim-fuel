...
vim.cmd [[
    augroup executor_statusline
        autocmd!
        autocmd BufDelete *_executor_main_console lua pcall(function() require('lualine').hide({unhide=true}) end)
    augroup end

    augroup console_prevent_bad_closing 
	    autocmd QuitPre *_executor_main_console :q!
    augroup end
